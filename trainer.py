...
class Trainer(object):
    ...
    def train_model(self):
        ...
        for epoch in range(self.epochs):
            ...
            if epoch - best_epoch > 20:
                break
            if (epoch+1 % self.min_epoch == 0):
                self.save_model_middle(best_model,epoch)
        #——————————————————————————————————————————
        # finnal save the best model
    ...
    def save_model_middle(self, model,epoch):
        torch.save(model.state_dict(), os.path.join(self.model_path, self.model_name + '_' + epoch + '.pth'))
